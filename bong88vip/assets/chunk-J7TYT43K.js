...
var CoinTossBettingSpotArea = (container, spotIndex) => {
  ...
  const areaName = CoinTossZIndex.bettingSpot.spotArea.n(spotIndex);
  console.log("betContainer", betContainer);
  console.log("areaName", areaName);
  const area = betContainer.getChildByName(areaName);
  console.log(area);
  return area;
};
...
//# sourceMappingURL=chunk-J7TYT43K.js.map
